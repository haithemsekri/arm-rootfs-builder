...
[ -z $ROOTFS_DL_URL ]  && ROOTFS_DL_URL="https://iweb.dl.sourceforge.net/project/arm-rootfs-ressources/ubuntu-base-16.04.6-base-arm64.tar.xz"
...
apt-get -y install --no-install-recommends util-linux nano openssh-server systemd \
   ...
   libglib2.0-dev uuid-dev symlinks gcc g++ libsystemd-dev dbus-user-session tzdata ifupdown
